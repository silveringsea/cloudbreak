...
public final class ApplicationUtils {
     ...
     */
    public static String getApplicationName(ContainerConstraint constraint, int componentNumber) throws CloudbreakOrchestratorFailedException {
     ...
     * @throws CloudbreakOrchestratorFailedException - if the ComponentType is unknown.
     */
    public static String getComponentName(ContainerConstraint constraint, int componentNumber) throws CloudbreakOrchestratorFailedException {
        switch (getComponentType(constraint)) {
            case AMBARIDB:
                return "ambaridb";
            case AMBARISERVER:
     ...
     * @return the fully qualified hostname for the component.
     */
    public static String getComponentHostName(ContainerConstraint constraint, OrchestrationCredential cred, int componentNumber)
        ...
        String domain = DomainUtils.getDomain(cred);
        return String.format("%s.%s.%s", component, application, domain);
    }
     ...
     */
    public static ComponentType getComponentType(ContainerConstraint constraint) throws CloudbreakOrchestratorFailedException {

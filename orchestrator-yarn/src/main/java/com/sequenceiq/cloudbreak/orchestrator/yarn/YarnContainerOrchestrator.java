...
public class YarnContainerOrchestrator extends SimpleContainerOrchestrator {
    ...
    private ApplicationSubmissionHandler submitHandler = new ApplicationSubmissionHandler();

    private ApplicationWaitHandler waitHandler = new ApplicationWaitHandler();

    private ApplicationDetailHandler detailHandler = new ApplicationDetailHandler();
